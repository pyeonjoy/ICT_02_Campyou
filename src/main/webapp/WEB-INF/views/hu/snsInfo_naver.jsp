...
<script type="text/javascript">
	...
	function save_go(f) {
        ...
        if (member_nickname === ""  || member_dob === "" || member_pwd === "" || member_pwdCheck === "" || member_phone === "" || member_gender === "") {
              ...
              <h2 class="text-uppercase text-center mb-3">정보수정</h2>
	              <form>
		                <div class="form-outline mb-2">
		                  <label class="form-label" for="member_nickname">닉네임<sup>*</sup></label>
