...
public class CampingGearBoardVO {
	private String cp_idx, member_idx, cp_subject, member_nickname, cp_content, cp_pwd, cpf_name, cp_regdate, cp_hit, cp_active, cp_notice, groups, step, lev, old_f_name;
